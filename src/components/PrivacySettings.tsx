...
const inputClass =
  "w-44 select-text rounded-lg border border-slate-900/10 bg-white/60 px-2.5 py-1.5 text-sm text-slate-800 outline-none transition-colors placeholder:text-slate-400 focus:border-accent/50 dark:border-white/10 dark:bg-white/5 dark:text-slate-100";
